...
export function EditorPanel({ resume, onUpdate }: EditorPanelProps) {
  ...
  // Fix the applyGeneratedBullets function
  const applyGeneratedBullets = () => {
    if (currentType === 'experience') {
      setNewExperience(prev => ({
        ...prev,
        description: generatedBullets // Directly set the generated bullets as the description
      }));
    ...
    setGeneratedBullets([]); // Clear the generated bullets after applying
  };
                    ...
                    onStartDateChange={(date) => {
                      if (date) {
                        setNewEducation({
                          ...newEducation,
                          startDate: date,
                          duration: newEducation.endDate ? formatDateRange(date, newEducation.endDate) : '',
                        })
                      }
                    }}
                    onEndDateChange={(date) => {
                      if (date) {
                        setNewEducation({
                          ...newEducation,
                          endDate: date,
                          duration: newEducation.startDate ? formatDateRange(newEducation.startDate, date) : '',
                        })
                      }
                    }}
                  />
